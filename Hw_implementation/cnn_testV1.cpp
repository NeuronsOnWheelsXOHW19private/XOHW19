...
int t=0;
float s;
hls::stream<float> fpgain("fpgain");
hls::stream<stream_out_data> fpgaout("fpgaout");
kernel(fpgain,fpgaout);
// i pesi dei conv. Layer
stream_out_data risultato;
float wc1[5][5][3][24];
float wc2[5][5][24][36];
float wc3[5][5][36][48];
float wc4[3][3][48][64];
...
ifstream take("C:/Hw_implementation/input.txt");
for(i=0;i<66;i++){
 	for(j=0;j<200;j++){
    	for(t=0;t<3;t++){
    		take >> s;
...
h=0;
t=0;
ifstream take1("C:/Hw_implementation/Wc1Now.txt");
for (i=0; i<24;i++){
	for (j=0; j<3;j++){
		for (h=0; h<5;h++){
			for (t=0; t<5;t++){
...
h=0;
t=0;
ifstream take2("C:/Hw_implementation/Wc2Now.txt");
...
take2.close();
ifstream take3("C:/Hw_implementation/Wc3Now.txt");
i=0;
j=0;
h=0;
t=0;
...
take3.close();
ifstream take4("C:/Hw_implementation/Wc4Now.txt");
i=0;
j=0;
h=0;
t=0;
...
take4.close();
ifstream take5("C:/Hw_implementation/Wc5Now.txt");
i=0;
j=0;
h=0;
t=0;
...
ifstream take6("C:/Hw_implementation/fc1Now.txt");
i=0;
j=0;
h=0;
t=0;
...
take6.close();
ifstream take7("C:/Hw_implementation/fc2Now.txt");
h=0;
t=0;
for (h=0; h<100; h++){
	for (t=0; t<50; t++){
...
ifstream take8("C:/Hw_implementation/fc3Now.txt");
h=0;
t=0;
for (h=0; h<50; h++){
	for (t=0; t<10; t++){
...
take8.close();
ifstream take9("C:\Hw_implementation\fc4Now.txt");
h=0;
t=0;
for (h=0; h<10; h++){
    take9 >> s;
...
h=0;
ifstream take10("C:/Hw_implementation/bc1Now.txt");
for (h=0; h<24; h++){
        take10 >> s;
		bc1[h] = s;
}
...
take10.close();
ifstream take11;
take11.open("C:/Hw_implementation/bc2Now.txt");
for (h=0; h<36; h++){
        take11 >> s;
		bc2[h] = s;
}
h=0;
ifstream take12("C:/Hw_implementation/bc3Now.txt");
for (h=0; h<48; h++){
        take12 >> s;
		bc3[h] = s;
}
h=0;
take12.close();
ifstream take13("C:/Hw_implementation/bc4Now.txt");
for (h=0; h<64; h++){
        take13 >> s;
		bc4[h] = s;
}
take13.close();
h=0;
ifstream take14("C:/Hw_implementation/bc5Now.txt");
for (h=0; h<64; h++){
        take14 >> s;
		bc5[h] = s;
}
h=0;
take14.close();
ifstream take15("C:/Hw_implementation/bfc1Now.txt");
for (h=0; h<100; h++){
        take15 >> s;
		bfc1[h] = s;
}
h=0;
take15.close();
ifstream take16("C:/Hw_implementation/bfc2Now.txt");
for (h=0; h<50; h++){
        take16 >> s;
		bfc2[h] = s;
}
...
take16.close();
ifstream take17;
take17.open("C:/Hw_implementation/bfc3Now.txt");
for (h=0; h<10; h++){
        take17 >> s;
		bfc3[h] = s;
}
